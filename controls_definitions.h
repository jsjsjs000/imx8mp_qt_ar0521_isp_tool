...
public:
	...
	void init(void)
	{
		...
		controls.append(new SliderControl(  IF_CPROC_S_CFG,   CPROC_BRIGHTNESS_PARAMS, "Brightness",              -128,   127,    0,    "Brightness value"));
		...
		controls.append(new SliderControl(  IF_CPROC_S_CFG,   CPROC_HUE_PARAMS,        "Hue",                      -90,    89,    0,    "Hue value"));
